...
gftools fix-unwanted-tables --tables MVAR "$ROOT_DIR/fonts/Jost-VF.ttf";
statmake --designspace "$ROOT_DIR/sources/designspace/jost.designspace" "$ROOT_DIR/fonts/Jost-VF.ttf"
